...
\name{Thrice Dead Prophet \image{edge} \hp{40}};
\setup{}
\unleash{Gain 5 life. If the nemesis has 60 or more life, gain a prophecy token.}
\rules{This nemesis has no maximum life. If the nemesis deck runs out of cards, the players lose immediately. At the end of a nemesis turn in which he has 3 or more prophecy tokens, discard the top card of the nemesis deck and lose 3 prophecy tokens. If Prophet has 99 life or higher, the players lose the game.};
\end{tikzpicture}
