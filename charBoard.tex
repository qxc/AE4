...
\newcommand{\notes}[1]{
	\node[text width=11cm, left] at (\squarewidth-.52, \squareheight*.1 - 1.1) {\footnotesize \textbf{Notes:} #1};
}

\newcommand{\sync}[1]{
\node[text width=\tw, left] at (\boardwidth*1.5, 4) {\footnotesize \textbf{#1}};
}
