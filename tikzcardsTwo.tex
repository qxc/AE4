...
\newcommand{\Wandering}{\textbf{Wandering} }% If this deals more than its base damage, }
...
\newcommand{\recallIcon}{
		\node at (\cardwidth/9, \cardheight*.94) {\includegraphics[height = .7cm]{recall}};
}
...
\newcommand{\sync}[1]{
	\node at (\cardwidth*.88, \cardheight*.85) {\tiny{#1}};
}
