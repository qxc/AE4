...
\newcommand{\expDifficulty}[1]{\node[text width = \tw] at (\cardwidth*.75, \cardheight*.95) {\textbf{Expert Difficulty:} #1};}

\newcommand{\nightDifficulty}[1]{\node[text width = \tw] at (\cardwidth*.75, \cardheight*.85) {\textbf{Nightmare Difficulty:} #1};}

\newcommand{\exhaustEffect}[1]{\node[text width = \tw] at (\cardwidth*.75, \cardheight*.75) {\textbf{Exhaust Effect:} #1};}

\newcommand{\rules}[1] {\node[text width = \tw] at (\cardwidth*.25, \cardheight*.6) {\large \textbf{Rules:} #1};}
